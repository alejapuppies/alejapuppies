...
export default class Card extends React.Component{
    render(){
        ...
        return(
            <div className="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 mx-auto p-1" style={{backgroundColor:"#C2FFFB"}}>
                <div className="card" style={{backgroundColor:"#fff"}}>
                    <img className="card-img-top" src={img} alt="Card image cap" width="250px" height="250px"/>
                    <div className="card-body">
                    <h5 className="card-title text-black text-center" style={{backgroundColor:"#C2FFFB"}}>{title}</h5>
